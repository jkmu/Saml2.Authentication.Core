namespace Microsoft.Extensions.DependencyInjection
{
    ...
    public static class Saml2ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddSigningCertificates(
            this IServiceCollection services,
            string serviceProviderCertificateThumbprint,
            string identityProviderCertificateThumbprint)
        {
            if (services == null)
            {
                throw new ArgumentNullException(nameof(services));
        ...
        public static IServiceCollection AddSigningCertificates(
            ...
            string serviceProviderCertificateName,
            string identityProviderCertificateName)
        {
            if (services == null)
            {
                throw new ArgumentNullException(nameof(services));
        ...
        /// <returns>IServiceCollection</returns>
        public static IServiceCollection AddSigningCertificatesFromFile(
            this IServiceCollection services,
            string serviceProviderCertificateFileName,
            string serviceProviderCertificatePassword,
            X509KeyStorageFlags x509KeyStorageFlag,
            string identityProviderCertificateFileName)
        {
            if (services == null)
            {
                throw new ArgumentNullException(nameof(services));
            ...
            var serviceProviderCertificate = new X509Certificate2(
                serviceProviderCertificateFullFileName,
        ...
        private static X509Certificate2 GetCertificate(
            string findValue, X509FindType findType,
        ...
        private static string SearchDescriptor(
            string findValue,
            X509FindType findType,
            StoreName storeName,
        ...
        private static SigningCertificate GetSigningCertificates(
            X509FindType findType,
            string serviceProviderCertificateName,
            string identityProviderCertificateName)
        {
        ...
        private static IServiceCollection AddSigningCertificates(
        ...
        private static void AddRequiredServices(this IServiceCollection services)
        {
            ...
            services.TryAddTransient<ISaml2XmlProvider, Saml2XmlProvider>();
            ...
            services.TryAddTransient<ISaml2AuthenticationProvider, Saml2AuthenticationProvider>();
